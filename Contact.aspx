<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="BookMovie.Contact" %>
...
<body style="background:url(image/header.png) no-repeat">
    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style1" style="margin-top: 100px">
            ...
            <tr>
                <td class="auto-style3">Deepak Kumar Shaw</td>
                <td>deepakkmr2504@yahoo.in</td>
            </tr>
            <tr>
                <td class="auto-style3">Rahul Roshan</td>
                <td><a href="mailto:rahulroshan123@gmail.com">rahulroshan123@gmail.com</a></td>
            </tr>
            <tr>
                <td class="auto-style3">Ayan Chaudhary</td>
                <td>ayanchaudhary@gmail.com</td>
            </tr>
            <tr>
                <td class="auto-style3">Rohit Kumar</td>
                <td>rohitkumar1234@gmail.com</td>
            </tr>
        </table>
